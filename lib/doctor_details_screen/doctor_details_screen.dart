import 'package:e_clinic/doctor_details_screen/controller/doctor_servces_controller.dart';
import 'package:e_clinic/util/button2.dart';
...
class _DoctorDetailsScreenState extends State<DoctorDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    final doctorServiceProviderData = Get.put(DoctorServiceController());
