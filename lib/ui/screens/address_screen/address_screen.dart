import 'package:e_clinic/controllers/address_card_controller.dart';
import 'package:e_clinic/util/input_field.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

import '../login/widgets/checkbox.dart';
import '../prefered_pharmacy_screen/preffered_pharmacy_screen.dart';
import '/../util/button1.dart';
import '/../util/colors.dart';
import '/../util/text_styles.dart';

class AddressScreen extends GetView<AddrescardController> {
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    controller.addressItems[0],
                    SizedBox(height: 30.h),
                    controller.addressItems[1],
                    SizedBox(height: 30.h),
                    controller.addressItems[2],
