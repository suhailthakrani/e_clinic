...
import 'package:e_clinic/ui/screens/appointments/appointment_list_view.dart';
import 'package:e_clinic/ui/screens/prescriptions/widgets/presription_list_view.dart';
          ...
          title: Padding(
            ...
            child: CustomSearchField(
              ...
              onTap: () {
                showSearch(
                  context: context,
                  delegate: DoctorSearchDelegate(controller.doctorsList,
                  ...
                  children: [
                    Expanded(
                      child: Material(
                        child: GestureDetector(
                          onTap: (){
                            Get.to(const AppointmentsListView());
                          },
                          child: Card(
                            color: kWhiteColor,
                    ...
                    Expanded(
                      child: Material(
                        child: GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder:(context) => PrescriptionsListView(),));
                            // Get.to(const PrescriptionsListView());
                          },
                          child: Card(
                            color: kWhiteColor,
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Text(
                                    'Check the prescription given to you',
                                    style: TextStyle(
                                      color: kTextColor,
                                      fontSize: 11,
                                    ),
